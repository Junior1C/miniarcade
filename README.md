...
| `assets/js/*.js` суммарно | 36 КБ | критический путь каталога + витрина |
| `assets/js/*` критический (без `stats-page.js`) | 28 КБ | главная: `stats-page.js` грузится только на `stats.html` (deferred), рост `main.js` виден отдельно |
