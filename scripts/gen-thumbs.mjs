// Генератор WebP-превью для карточек (400px по ширине, q68, метод 6).
...
// q68: баланс веса и качества — ширина ужата под карточку (400px),
// поэтому качество подняли обратно с q60 без роста суммарного веса.
...
const NOTHUMB_BRIDGES = new Set([
  'duckhunt-mattsurabian', // Чёрный пустой кадр (нужен клик для старта).
  'emoji-mines-muan', // Белый лист, игра ниже фолда.
  'netwalk-frosetrain', // Кадр выходит экраном «Loading...» (p5 с CDN не успевает за скриншот) — честнее эмодзи.
  'wordle-plus-leandrosq', // Пустой кадр: React-приложение не успевает за скриншот — честнее эмодзи.
  'ultimate-ttt-ishandutta2007', // Чёрный кадр: WASM-движок не успевает за скриншот — честнее эмодзи.
]);
