...
// Панель оформления грузится лениво по первому клику (dynamic import
// в main.js) — в критический путь не входит, как и витрина статистики.
const JS_DEFERRED = new Set(['stats-page.js', 'settings.js']);
